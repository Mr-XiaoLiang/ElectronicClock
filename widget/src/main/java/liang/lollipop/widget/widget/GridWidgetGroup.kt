...
class GridWidgetGroup(
     ...
     * 用来绘制选中面板边框效果的回调函数
     */
    private var drawSelectedPanelListener: ((panel: Panel<*>, mode: DragMode, canvas: Canvas) -> Unit)? =
        null
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            val info = panel.panelInfo
            view.measure(
                MeasureSpec.makeMeasureSpec(info.spanX * gridSize.width, MeasureSpec.EXACTLY),
